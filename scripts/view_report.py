...
class DashboardIngestion:
    ...
    def dash_board_service(self):
        with st.container():  # Container Services Report
            ...
            execution_time_total_ingestion = round(self.df_selection['TOTAL TIME INGESTION(sec)'].sum(), 2)
            ...
            execution_time_total_ingestion_service = round(self.df_selection['INGESTION SERVICE TOTAL TIME'].sum(), 2)
            ...
            execution_time_total_message_broker_service = round(self.df_selection['MESSAGE BROKER TOTAL TIME'].sum(), 2)
            ...
            with st.expander('Services Charts'):
                ...
                service_chart_line.update_layout(title='<b>Average Time (sec)</b>',
                                                 xaxis_title='<b>Service</b>', yaxis_title='<b>Average Time (sec)</b>',
    ...
    def dash_boar_message_type(self):
        with st.container():
            ...
            summary = self.df_selection.groupby(
                ...
                .agg({'TOTAL TIME INGESTION(sec)': 'mean',
            ...
            with st.expander('Message Type Charts'):
                ...
                message_type_chart_pay = go.Figure(data=[go.Pie(labels=message_type_, values=elapsed_time_pay_chart)])
